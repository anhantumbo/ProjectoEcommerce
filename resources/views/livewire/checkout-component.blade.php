  ...
  <div class=" main-content-area">
    ...
    <div class="wrap-address-billing"> 
					...
					<form wire:click.prevent="placeOrder">
                      ...
                      <p class="row-in-form">
                        <label for="city">Província<span></span></label>
                        <input  type="text" name="city" value="" placeholder="Província"  wire:model="province">
        ...
        <div class="col-md-12">
                  <div class="wrap-address-billing">
                    ...
                    <div class="billing-address">
                      ...
                      <p class="row-in-form">
                        <label for="city">Província<span></span></label>
                        <input  type="text" name="city" value="" placeholder="Província"  wire:model="s_province">
                        @error('s_province') <span class="text-danger">{{$message}}</span> @enderror
                      </p>

                      <p class="row-in-form">
                        <label for="city">Cidade<span>*</span></label>
                        <input  type="text" name="city" value="" placeholder="Cidade"  wire:model="s_city">
      ...
      <div class="summary-item payment-method">
        ...
        <div class="choose-payment-methods">
          ...
          <label class="payment-method">
            <input name="payment-method" id="payment-method-paypal" value="mpesa" type="radio" wire:model="paymentmode">
            <span class="row-in-form"> Mpesa</span>
           
            
            <input class="payment-desc" name="payment-method" id="payment-method-paypal" type="text">
      ...
      <div class="summary-item shipping-method">
        ...
        <p class="summary-info"><span class="title">Fixed MZN 50.00</span></p>
